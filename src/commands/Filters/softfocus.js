...
module.exports = {
  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      // 🌙 Detect if Soft Focus is already active
      const isActive =
      ...
      // 🛰 Send safely to Lavalink or Riffy
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:icons_cross:1466118143301652584> | **Soft Focus filter disabled.** Back to normal clarity"
            : "<:check:1466333427304497153> | **Soft Focus filter enabled!** A dreamy and mellow vibe"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:icons_cross:1466118143301652584> | Failed to toggle Soft Focus filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },
